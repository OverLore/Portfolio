<body style="background-color: white;">
	...
	<p>
		These terms and conditions apply to the OneMoreJump app (hereby referred to as "Application")
		for mobile devices that was created by Zelham (hereby referred to as "Service Provider") as an
	...
	<p>
		...
		for the Application or its services will be clearly communicated to you.
	</p>
	<br />
	<p>
		The Application stores and processes personal data that you have provided to the Service
		Provider in order to provide the Service. It is your responsibility to maintain the security of
		your phone and access to the Application. The Service Provider strongly advise against
		jailbreaking or rooting your phone, which involves removing software restrictions and
		limitations imposed by the official operating system of your device. Such actions could expose
		your phone to malware, viruses, malicious programs, compromise your phone's security features,
	...
	<div bis_skin_checked="1">
		<p>
			...
			Conditions. Below are the links to the Terms and Conditions of the third-party service
		...
		<ul>
			<li>
				<a
					...
					bis_skin_checked="1">Google Play Services</a
				>
			</li>
			<!----><!----><!----><!----><!----><!----><!----><!----><!----><!---->
			<li>
	...
	<p>
		...
		experience as a result of relying entirely on this functionality of the application.
	</p>
	<br />
	<p>
	...
	<br />
	<p>These terms and conditions are effective as of 2025-05-19</p>
	...
	<p>
		...
		to contact the Service Provider at zelhkdev@gmail.com.
	</p>
	<hr />
	<p>
		This Terms and Conditions page was generated by <a
			...
			target="_blank"
			rel="noopener noreferrer"
			bis_skin_checked="1">App Privacy Policy Generator</a
		>
	</p>
</body>
